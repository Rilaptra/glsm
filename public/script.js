    ...
    <div class="bg-white rounded-lg shadow-xl drop-shadow overflow-hidden p-4">
        <div class="grid grid-cols-3 gap-4 mb-4">
            <div class="col-span-1">
                <img src="${server.logo}" alt="${server.name}" class="w-full shadow-md drop-shadow rounded-xl h-auto object-contain">
            </div>
            <div class="col-span-2">
                <h5 class="text-lg sm:text-md font-semibold row-span-1">${server.name}</h5>
                <p class="text-gray-600 text-sm row-span-2">${server.description}</p>
            </div>
        </div>
        <div class="flex items-center text-sm text-gray-500 divide-x divide-gray-300">
